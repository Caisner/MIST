...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='Ade', help='Dataset name')
    ...
    parser.add_argument('-q', '--quality', type=int, default=90, help='JPEG compression quality [70]')
    ...
    parser.add_argument('-m', '--magnifications', type=int, nargs='+', default=(1, 2),
