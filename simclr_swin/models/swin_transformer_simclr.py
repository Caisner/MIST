...
def SwinTransformerSimCLR(num_classes: int = 1000, **kwargs):
    # trained ImageNet-1K
...
def SwinTransformerEmbedder(num_classes: int = 1000, **kwargs):
    # trained ImageNet-1K
    # https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth
    model = SwinTransformerFeatureExtractor(in_chans=3,
                            patch_size=4,
                            window_size=7,
                            embed_dim=96,
                            depths=(2, 2, 6, 2),
